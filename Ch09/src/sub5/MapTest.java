 ...
 * 
 * Map
 * - 키 값(key value) 쌍으로 이루어진 자료 구조
 * - Map을 구현한 HashMap을 많이 사용하고 키를 이용해서 List 보다 빠른 탐색 수정
 * 
 */
public class MapTest {
	...
	public static void main(String[] args) {
		...
		// Map 크기
		System.out.println("데이터 크기: "+ map.size());
		
		// Map 출력
		System.out.println("mak A값: "+ map.get('A'));
		System.out.println("mak B값: "+ map.get('B'));
		System.out.println("mak C값: "+ map.get('C'));
		...
		m1.put(103, new Apple("미국", 1000));
		
		Map<Integer, Apple> m2 = new HashMap<>();
		m2.put(201, new Apple("일본", 3000));
