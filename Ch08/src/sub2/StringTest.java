...
public class StringTest {
	public static void main(String[] args) {
		...
		// 문자열 생성
		String str1 = "Hello"; //암시적(리터럴 방식)
		String str2 = new String ("Hello"); //명시적(원칙)
		...
		// 문자열 비교
		if(str1==str2) {
			System.out.println("str1의 주소와 str2의 주소가 같다.");
		}else {
			System.out.println("str1의 주소와 str2의 주소가 다르다.");
		}
		
		if (str1.equals(str2)) {
			System.out.println("str1의 문자열과 str2의 문자열이 같다.");
		}else {
			System.out.println("str1의 문자열과 str2의 문자열이 다르다.");
		}
