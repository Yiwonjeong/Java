...
public class RegularExpressTest {
	public static void main(String[] args) {
		...
		boolean r3 = Pattern.matches(patt, "boo123");
		...
		String [] patterns = {
							  "[a-z]?", 	// 영어 소문자 1개
							  "[0-9]+",		// 숫자 1개 이상 (+: 1개 이상)
							  "0[0-9]*",	// 0으로 시작하는 숫자 0개 이상 (*: 0개 이상)
							  "^[0-9]",		// 숫자로 시작하는 문자 (^:start)
							  ".", 			//문자 1개
							  "[^0-9]", 	// 숫자가 아닌 문자   (^: not)
							  "[a-z]*",		// 영어 소문자 0개 이상
							  "[a-z]+",		// 영어 소문자 1개 이상
		...
		String ptt1 = "^[a-zA-Z0-9]*"; 			//a~z, A~Z, 0~9
		String ptt2 = "^[가-힣]*$";  		
		String ptt3 = "(01\\d{1})-(\\d{3,4})-(\\d{4})"; 
		//() group 011,016,015... , 3자리4자리, 4자리 -> 휴대폰 
		String ptt4 = "(\\w+)@(\\w+).(\\w+)";
		// email 
		
		String str = "이름: 홍길동, 휴대폰: 010-1234-1011, 휴대폰: 011-123-1001, 이메일: hong@gmail.com";
